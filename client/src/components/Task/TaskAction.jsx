...
export default function TaskAction({ handleEditButtonClick, handleCloseEdit }) {
	const { task_action_btn } = classes;
	return (
		<div style={{ position: 'absolute', right: '10px', top: '10px' }}>
			<button onClick={handleEditButtonClick} className={task_action_btn}>
			...
			<button className={task_action_btn}>
				<svg
