...
import styles from './EditTaskFormStatus.module.css';
import { TASK_STATUS } from '../../../../utils/constants';

export default function EditTaskFormStatus({ setSelectedStatus,task }) {
	// component styles
		...
		<>
			...
			>
				<select
					...
					name='status'
				></select>
				{selectedOption === '' ? task.status : selectedOption}
				{isDropdownOpen && (
